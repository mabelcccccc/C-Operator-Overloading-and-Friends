...
Rectangle::Rectangle(string name, bool containsWrapSpace)
...
void Rectangle::computeArea(){
    ...
    //cout << "--------------------------"<< endl;
    //cout << "Calculate Area method"<< endl;
...
bool Rectangle::isPointInShape(int x, int y){ //exclude the ones that are already Point and add those points in the PointsInShape vector
...
void Rectangle::displayVerticesInShape(){ //determine the points that are in shape, and display those points
    int xP;
    int yP;
    bool check;
...
void Rectangle::displayVerticesOnShape(){ 
    bool check;
    //cout << "smallestX: " << smallestX << endl;
    //cout << "smallestY: "<< smallestY << endl;
    //cout << "biggestX: " << biggestX << endl;
